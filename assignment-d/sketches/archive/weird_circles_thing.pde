...
void keyReleased() {
  ...
  if (key == 'm') background(255); stroke(0, 50);
  if (key == 'n') background(0); stroke(75);
  if (key == 'b') background(random(255),random(255),random(255)); stroke(75);
  if (key == 'v') stroke(random(mouseX/50));
